...
export default async function handler(req, res) {
  ...
  try {
    ...
    const url = `https://maps.apigw.ntruss.com/map-reversegeocode/v2/gc?request=coordsToaddr&coords=${coords}&sourcecrs=epsg:4326&orders=addr,roadaddr&output=json`;
